...
const ProblemList = () => {
  ...
  return (
    <div className='p-0'>
      <h1 className="mb-6 py-5  text-center lg:text-3xl text-xl text-white font-extrabold bg-black">LeetCodeAnalysis.io</h1>
        <div >
        <div className="lg:p-4 py-4 flex justify-center w-full">
          <div className="flex flex-col lg:flex-row mb-4 w-fit lg:w-auto space-y-2 lg:space-y-0 lg:space-x-2 sm:w-full sm:justify-center sm:items-center">
            <input
              type="number"
              placeholder="Min Rating"
              onChange={handleMinChange}
              className="lg:px-4 py-2 border rounded"
            />
            <input
              type="number"
